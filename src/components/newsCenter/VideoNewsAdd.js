...
class VideoNewsAdd extends React.Component {
    constructor() {
        super();
        this.state = {
            ...
            <Container>
                ...
                >
                    <FormItem style={{ marginBottom: '20px' }}>
                        <Label align="top"><RedStart>*</RedStart>新闻标题： </Label>
                    ...
                    <FormItem style={{ marginBottom: '20px' }}>
                        <Label align="top"><RedStart>*</RedStart>新闻内容： </Label>
